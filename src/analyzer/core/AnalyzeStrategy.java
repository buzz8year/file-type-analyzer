...
public class AnalyzeStrategy {
    ...
    public AnalyzeStrategy(String algo) {
        if (Objects.equals(algo, "--naive")) setAnalyzer(new NaiveAnalyzer());
        else if (Objects.equals(algo, "--KMP")) setAnalyzer(new KMPAnalyzer());
        else if (Objects.equals(algo, "--RK")) setAnalyzer(new RKAnalyzer());
    }
